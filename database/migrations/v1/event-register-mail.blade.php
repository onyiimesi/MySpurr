<!DOCTYPE html>
 ...
 <body>
    ...
    <div class="main">
        <h3>Dear {{ $info->first_name }} {{ $info->last_name }}</h3>

        <p class="trial">
            Thank you for registering for our upcoming MySpurr webinar, {{ $event->title }} We're thrilled to have you join us for this insightful and inspiring session.
        </p>
        <p>
            Event Details:
        </p>
