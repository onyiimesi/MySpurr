              ...
              <td class="table_center">
                ...
                <table class="table3">
                  <tr>
                    ...
                    <td class="col2">
                      ...
                      <p>Plot 228. 1(R), 32 Road FHA,</p>
                      <p>Lugbe FCT Abuja</p>
                      <p class="vat">VAT number. 24074249-0001</p>
                    </td>
                  </tr>
                </table>
                <table class="table4">
                  <tr>
                    ...
                    <td class="col2">
                      <table>
                        <thead>
                          <tr class="head">
                            <th class="key">Transaction Date:</th>
                        ...
                        <tbody class="tableBody">
                          <tr>
                            ...
                            <td>Paystack (Debit/Credit Cards)</td>
                          </tr>
                          <tr>
                      ...
                      <table>
                        <tr>
                          <td class="no_padding padding_right">
                            <table>
                              <tr>
                                <td class="align-left">Subtotal in Naira</td>
                                <td>₦{{ $payment->total_amount }}</td>
                              </tr>
                              <tr>
                        ...
                        <tr>
                          <td class="no_padding padding_right">
                            <table>
                              <tr>
                                <td class="align-left">Total in Naira:</td>
                                <td>₦{{ $payment->amount }}</td>
                              </tr>
                              <tr>
                                <td class="align-left">Transaction Amount:</td>
                                <td>₦{{ $payment->amount }}</td>
                              </tr>
                            </table>
                          </td>
                ...
                <table class="table7">
                  <tr>
                    <td>
                      <p>PLEASE NOTE:</p>
                      <p>- ALL BANK DEPOSIT OR TRANSFERS DIRECTLY INTO OUR BANK ACCOUNTS ARE NOT ALLOWED.
                      </p>
                      <p>
                        - ALL INVOICES PAST THE INVOICED DATE ARE VOID, PLEASE CONTACT SALES TO GENERATE A NEW INVOICE,
                      </p>
                      <p>- RECURRING BILLING IS CONTINUOUS INCLUDING WHEN SERVICE IS SUSPENDED.
                      </p>
                      <p>
                        - ANY PAYMENT NOT CONFIRMED WITHIN 12HRS, PLEASE EMAIL SUPPORT@MYSPURR.NET TO CONFIRM PAYMENT TO
                        AVOID POST
                        SUSPENSION/TERMINATION.
                      </p>
                      <p>- YOU ARE TO CONFIRM SERVICE/S PAID FOR (FULL-TIME/CONTRACT/PART-TIME HIRE) ARE DONE & ACTIVE
                        WITHIN 24HRS, ELSE EMAIL SUPPORT@MYSPURR.NET.</p>
                    </td>
                  </tr>
                </table>
              </td>
