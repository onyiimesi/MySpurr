    ...
    <style>
        ...
        *,
        ...
        @media only screen and (max-width: 620px) {
            ...
            .viewText {
                background-color: #43D0DF !important;
                color: #000;
                        ...
                        <tr>
                            <td class="">
                                ...
                                <table class="table2">
                                    ...
                                    <tr>
                                        <td>
                                            <h3>Your application was sent to {{ $business->business_name }}</h3>
                                        </td>
                                    </tr>
                                </table>
                                <table class="table3">
                                                    ...
                                                    <td>
                                                        <table>
                                                            <tr class="topRow">
                                                                @php
                                                                    $image =
                                                                        $job->business->company_logo !== null
                                                                            ? $job->business->company_logo
                                                                            : 'https://backend-api.myspurr.net/public/assets/userplaceholder.jpg';
                                                                @endphp
                                                                <td class="img">
                                                                    <img src="{{ $image }}"
                                                                                            ...
                                                                                            <table>
                                                                                                <tr class="row">
                                                                                                    <td
                                                                                                        class="img time">
                                                                                                        <!-- calender png -->
                                                                                                        <img src="https://backend-api.myspurr.net/public/assets/calendar.png"
                                                                                            ...
                                                                                            <table>
                                                                                                <tr class="row">
                                                                                                    <td
                                                                                                        class="img location">
                                                                                                        <!-- location png -->
                                                                                                        <img src="https://backend-api.myspurr.net/public/assets/location_on.png"
                                                                                                            style="width: 100%; height: 100%;"
                                                                                                            alt="">
                                                                                                    </td>
                                                                                                    <td
                                                                                            ...
                                                                                            <table>
                                                                                                <tr class="row">
                                                                                                    <td
                                                                                                        class="img schedule">
                                                                                                        <!-- timer png -->
                                                                                                        <img src="https://backend-api.myspurr.net/public/assets/timer.png"
                                                                                                            style="width: 100%; height: 100%;"
                                                                                                            alt="">
                                                                                                    </td>
                                                                                                    <td
                                                            ...
                                                            <tr>
                                                                <td class="col1">
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            <td class="img">
                                                                                <img src="https://backend-api.myspurr.net/public/assets/verified.jpg"
                                                                                    alt="">
                                                                            </td>
                                                                            <td>
                                                                                <p class="text">
                                                                                                            ...
                                                                                                            <table>
                                                                                                                <tr
                                                                                                                    ...
                                                                                                                    <td
                                                                                                                        class="img time">
                                                                                                                        <!-- calender png -->
                                                                                                                        <img src="https://backend-api.myspurr.net/public/assets/calendar.jpg"
                                                                                                                            style="width: 100%; height: 100%;"
                                                                                                                            alt="">
                                                                                                                    </td>
                                                                                                                    <td
                                                                                                            ...
                                                                                                            <table>
                                                                                                                <tr
                                                                                                                    ...
                                                                                                                    <td
                                                                                                                        class="img location">
                                                                                                                        <!-- location png -->
                                                                                                                        <img src="https://backend-api.myspurr.net/public/assets/location_on.jpg"
                                                                                                                            style="width: 100%; height: 100%;"
                                                                                                                            alt="">
                                                                                                                    </td>
                                                                                                                    <td
                                                                                                            ...
                                                                                                            <table>
                                                                                                                <tr
                                                                                                                    ...
                                                                                                                    <td
                                                                                                                        class="img schedule">
                                                                                                                        <!-- timer png -->
                                                                                                                        <img src="https://backend-api.myspurr.net/public/assets/timer.jpg"
                                                                                                                            style="width: 100%; height: 100%;"
                                                                                                                            alt="">
                                                                                                                    </td>
                                                                                                                    <td
                                    ...
                                    <tr>
                                        <td>
                                            <div class="btn btn-primary">
                                                <a href="https://www.myspurr.net/jobs" target="_blank">see more
                                                    jobs</a>
                                            </div>
                                        </td>
                                    </tr>
